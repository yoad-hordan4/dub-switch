If you hate it when you write text in one language but your computer input was in another, this will fix your life!
...
2. Double-click `HebrewEnglishSwitcher.app` to open it
3. A permission prompt will appear — click **Open**
4. Go to **System Settings → Privacy & Security → Accessibility**
5. Click the **+** button and add `HebrewEnglishSwitcher`
6. The switcher is now running in the background
